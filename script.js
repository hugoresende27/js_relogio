...
toggle.addEventListener('click', (e) => {
    const html = document.querySelector('html') /*PARA MUDAR ENTRE DARK MODE E LIGHT MODE */
...
function setTime (){
    ...
    tempoEl.innerHTML = `${hora} : ${minuto < 10 ? `0${minuto}` : minuto}`
    dataEl.innerHTML = `${dias[dia]} dia  <span class="circulo">${data}</span> ${meses[mes]} de ${ano}`
}
